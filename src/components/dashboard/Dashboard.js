            ...
            <React.Fragment>
                ...
                <div className="wrapper">
                    ...
                    <div id="content">
                        ...
                        {/* </Switch> */}
                        <Route exact path={this.props.match.url}  element={<Publicaciones/>}/>
                        <Route path={`${this.props.match.url}/miPerfil`} element={<MiPerfil/>}/>
                        <Route path={`${this.props.match.url}/misPublicaciones`} element={<MisPublicaciones/>}/>
                        <Route path={`${this.props.match.url}/misOfertas`} element={<MisOfertas/>}/>
                        <Route path={`${this.props.match.url}/misMensajes`} element={<Mensaje/>} />
                        <Route path={`${this.props.match.url}/reciclar`} element={<Reciclar/>}/>
                        <Route path={`${this.props.match.url}/publicaciones`} element={<Publicaciones/>}/>
                        {/* <Route path={`${this.props.match.url}/publicaciones`} render={()=>{return(<Publicaciones></Publicaciones>)}}/> */}
                        <Route path={`${this.props.match.url}/publicacion/:publi_id`} element={<Publicacion/>}/>
